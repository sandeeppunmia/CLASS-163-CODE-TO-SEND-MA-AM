AFRAME.registerComponent("wired-fence",{
    init:function(){
        posX=-20;
        posZ=84
        for(var i=0;i<10;i++){
            ...
            wireFence2.setAttribute("id","wireFence1"+i)
            wireFence3.setAttribute("id","wireFence1"+i)
            wireFence4.setAttribute("id","wireFence1"+i)
            ...
            wireFence4.setAttribute("position",{x:posX,y:2.5,z:posZ});
